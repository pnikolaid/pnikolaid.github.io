...
This is simple to do but wasteful since the traffic of a slice varies over time and so does its resource demand. To enable dynamic resource adaptation for reduced provisioned resources, we propose the following architecture:
