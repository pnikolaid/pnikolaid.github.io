...
**Proposed Bandwidth Demand Estimator** (details in "Data-driven Bandwidth Adaptation for Radio Access Network Slices" <a href="https://arxiv.org/abs/2311.17347">  <i class="fas fa-solid fa-file"></i> </a>)<br/>
...
**Proposed Network Slice Multiplexer** (details in "Resource Efficiency vs Performance Isolation Tradeoff in Network Slicing" <a href="https://ieeexplore.ieee.org/document/10349807">   <i class="fas fa-solid fa-file"></i></a>) <br/>
